...
class EFOTraitSearch(PGSSearch):
    ...
    def __init__(self, query):
        self.query = query
        self.fields = ["id^2","label^2","synonyms^2","mapped_terms","traitcategory_set.label","traitcategory_set.parent","score_set.id","score_set.name","score_set.trait_reported","trait_parents^2"]
