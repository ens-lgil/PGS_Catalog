var rest_url = 'http://127.0.0.1:8000/rest/release/'
...
function draw_js_barchart(data_chart, id, type) {
  ...
  //bg_colours   = ['DarkSeaGreen','DodgerBlue','SandyBrown'];
...
function draw_combined_js_barchart(data_chart, id) {
  ...
  //bg_colours = [ '#007C82', '#00adb5', '#BE4A81', '#e83e8c'];

  for(var i=0;i<data_chart.length;i++) {
    data_label.push(data_chart[i].date);
    console.log(data_chart[i])
  ...
  new Chart(document.getElementById(id), {
    ...
    data: {
      labels: data_label,
      //datasets: [ scoreData, publicationData, performanceData ]
...
function draw_combined_js_linechart(data_chart, id) {
  ...
  //colours = [ '#007C82', '#00adb5', '#BE4A81', '#e83e8c'];
